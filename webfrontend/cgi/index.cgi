...
# Title
$template_title = "Raumserver Plugin";
...
print 'No config menu available. Refer to the help text in the LoxWiki to configure raumserver via command line.'; 


# Load sample html from github plugin <!--$VARNAME--> with perl variable $VARNAME
#open(F,"$installfolder/data/node_modules/node-raumserver/test/index.html") || die "Missing template $installfolder/data/node_modules/node-raumserver/test/index.html";
#  while (<F>) {
#    $_ =~ s/<!--\$(.*?)-->/${$1}/g;
#    print $_;
#  }
